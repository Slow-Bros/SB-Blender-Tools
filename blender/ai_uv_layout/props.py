...
class SBAIUVSettings(bpy.types.PropertyGroup):
    ...
    # Ergebnis des letzten Transfers in diese Datei, nur zur Anzeige.
    # Fortschritt und Status laufender Jobs liegen am Job selbst
    # (operators._Job), denn ein Job ueberlebt den Wechsel der Datei, die
    # Szene nicht.
